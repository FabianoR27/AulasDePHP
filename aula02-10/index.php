...
echo "<h1>1. Definindo o preço de roupas com switch e if/else</h1>";
...
echo "<h1>2. Calculando média de alunos</h1>";
...
echo "<h1>3. Lista e soma de números pares e 1 a 50 e armazenando em um array</h1>";
$soma = 0;
...
echo "<h1>4. Simulador de caixa eletrônico simples</h1>";
...
echo "<h1>5. Carrinho de compras</h1>";
// Array de produtos disponíveis
$produtos = [
    ['nome' => 'Arroz', 'preco' => 29.90],
    ['nome' => 'Feijão', 'preco' => 19.90],
    ['nome' => 'Café', 'preco' => 49.90],
    ['nome' => 'Açúcar', 'preco' => 20.00],
    ['nome' => 'Leite', 'preco' => 10.00]
];
$precoTotal = 0;
...
echo "<br><strong>Preço total dos produtos:</strong> R$ " . number_format($precoTotal, 2, ',', '.');
echo "<hr>";

// --------------------------------------------------------------

echo "<h1>6. Array de salários</h1>";
$salarios = [1500.00, 3200.50, 1800.75, 4000.00, 1500.25, 2200.00, 4530.55];
$contador = 0;

echo "<strong>Quem ganha menos de R$2000,00 terá um aumento gigante de 10% no salário! (Vitória chegou!)</strong><br><br>";
